resource "aws_instance" "k6" {
    ...
    depends_on = [aws_ssm_parameter.base_url]
...
echo "k6 EC2 User Data 완료: $(date)"




cat > /home/ubuntu/k6/docker-compose.yml <<'EOC'
services:
  k6:
    image: grafana/k6
    ...
    environment:
      ...
      - K6_PROMETHEUS_RW_SERVER_URL=$${PROMETHEUS_RW_URL:-http://${var.monitoring_server_ip}:9090/api/v1/write}
...
cat > /home/ubuntu/k6/scripts/scenario.js <<'EOS'
